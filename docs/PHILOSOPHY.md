...
> This is not a habit. It is an obligation.

## Why screen-time settings fail
...
There is no escape hatch, and that is not an oversight. An escape hatch is exactly what makes every other app fail. If you can remove the lock easily, you will, and the app will have done nothing but add friction to a moment you were going to lose anyway.

So this gives you something the comfortable apps won't: a decision that stays decided. That is genuinely less pleasant, and it is the only version that works.

## Treat it with respect

Install it on a device you are willing to factory reset. Test it on a spare device before trusting it with a phone you depend on. Turning on the hardening options closes the last doors you might later want open. Freedom here is front-loaded: you use all of it at setup, then live with the choice.
